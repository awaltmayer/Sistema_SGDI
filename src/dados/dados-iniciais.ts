...
export const cartoes: CartaoTarefa[] = [
  {
    ...
    time_tracker: {
      ...
      pauses: [{ id: 'pause-1', paused_at: '2026-06-29T10:00:00Z', resumed_at: '2026-06-29T10:30:00Z', duration_seconds: 1800, reason: 'Reunião de alinhamento' }],
    },
  },
  {
    id: 'c2',
    ...
    time_tracker: { is_running: false, total_spent_seconds: 3600, pauses: [] },
  },
  {
    id: 'c3',
    ...
    time_tracker: { is_running: false, total_spent_seconds: 7200, pauses: [] },
  },
  {
    id: 'c4',
